...
namespace Jellyfin.Plugin.JellyfinElevate.Tests.Configuration
{
    ...
    public class UserFileReadCompatTests : IDisposable
    {
        ...
        private string UserDir => Path.Combine(_baseDir, "configurations", "Jellyfin.Plugin.JellyfinElevate", UserId);
        ...
        {
            var configDir = Path.Combine(_baseDir, "configurations", "Jellyfin.Plugin.JellyfinElevate");
