...
public class PluginHttpClientsTests
{
    ...
    public void CreateArrClient_RequestsTheNamedArrClient()
    {
        ...
        Assert.Equal("JellyfinElevateArr", Assert.Single(factory.RequestedNames));
    }
    ...
    public void CreateTmdbClient_RequestsTheNamedTmdbClient()
    {
        ...
        Assert.NotNull(client);
        Assert.Equal("JellyfinElevateTmdb", Assert.Single(factory.RequestedNames));
    }
    ...
    public void CreateClients_FallBackToDefaultClient_WhenNamedRegistrationIsUnavailable()
    {
        ...
        Assert.NotNull(tmdb);
        Assert.Equal(
            new[] { "JellyfinElevateArr", string.Empty, "JellyfinElevateTmdb", string.Empty },
