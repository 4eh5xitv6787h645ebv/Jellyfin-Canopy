...
// it orchestrates — JC.discoveryFilter, JC.seamlessScroll, JC.jellyseerrAPI,
// JC.jellyseerrUI cards, JC.requestManager metrics — is Seerr plumbing and
...
function createDiscovery(spec: any): DiscoveryController {
    ...
    function initialize() {
        ...
        // on a navigation.
        const lifecycle = JC.core.lifecycle!.register(`jellyseerr-${key}-discovery`);
