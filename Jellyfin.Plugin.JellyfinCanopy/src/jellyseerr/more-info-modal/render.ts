                    ...
                    <div class="modal-left">
                        ...
                        ${data.overview ? `
                            <div class="overview-section">
                                <h3>${JC.t!('jellyseerr_modal_overview') || 'Overview'}</h3>
    ...
    <div class="jc-more-info-right-panel">
        ...
        <div class="jc-more-info-stats-panel">
            <div class="jc-more-info-stat-row">
                <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_status')}</div>
            ...
            ${mediaType === 'tv' ? `
                ${data.firstAirDate ? `
                    <div class="jc-more-info-stat-row">
                        <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_first_air_date')}</div>
                ...
                ${data.lastAirDate ? `
                    <div class="jc-more-info-stat-row">
                        <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_last_air_date')}</div>
            ...
            ` : `
                ${releaseDate ? `
                    <div class="jc-more-info-stat-row">
                        <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_release_date')}</div>
            ...
            ${revenue ? `
                <div class="jc-more-info-stat-row">
                    <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_revenue')}</div>
            ...
            ${budget ? `
                <div class="jc-more-info-stat-row">
                    <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_budget')}</div>
            ...
            ${data.originalLanguage ? `
                <div class="jc-more-info-stat-row">
                    <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_original_language')}</div>
            ...
            ${data.productionCountries?.length ? `
                <div class="jc-more-info-stat-row">
                    <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_production_country')}</div>
            ...
            ${data.productionCompanies?.length ? `
                <div class="jc-more-info-stat-row">
                    <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_studios')}</div>
...
return `
    <div class="jc-more-info-stat-row">
        <div class="jc-more-info-stat-label">${JC.t!('jellyseerr_modal_streaming')}</div>
    ...
    <div class="jc-collection-card">
        ...
        <div class="jc-collection-card-content">
            ...
            <button class="jc-collection-card-button" data-collection-id="${escapeHtml(collection.id)}" data-collection-name="${escapeHtml(collection.name)}">
                ${JC.t!('jellyseerr_btn_view_collection') || 'View'}
            </button>
        </div>
    </div>
`;
...
return `
    <div class="keywords-section">
        <h3>${JC.t!('jellyseerr_modal_keywords') || 'Keywords'}</h3>
...
if (mediaType === 'tv' && data.createdBy?.length) {
    return `
        <div class="creators">
            <h4>${JC.t!('jellyseerr_modal_created_by') || 'Created By'}</h4>
...
if (data.credits?.crew) {
    ...
    if (director) {
        html += `
            <div class="crew-item">
                <h4>${JC.t!('jellyseerr_modal_director') || 'Director'}</h4>
    ...
    if (writers.length) {
        html += `
            <div class="crew-item">
                <h4>${JC.t!('jellyseerr_modal_writers') || 'Writers'}</h4>
...
return `
    <div class="trailers-section">
        <h3>${JC.t!('jellyseerr_modal_trailers')}</h3>
...
return `
    <div class="cast-section">
        <h3>${JC.t!('jellyseerr_modal_cast')}</h3>
