...
ui.addMainStyles = function () {
    ...
    style.textContent = `
        ...
        @media (max-width: 768px) {
            ...
            .jellyseerr-card .jc-hide-btn,
            .jellyseerr-card .jc-hide-btn.jc-already-hidden { width: 24px; height: 24px; font-size: 14px; }
            .jellyseerr-card .jc-hide-btn .material-icons { font-size: 14px; }
        }
