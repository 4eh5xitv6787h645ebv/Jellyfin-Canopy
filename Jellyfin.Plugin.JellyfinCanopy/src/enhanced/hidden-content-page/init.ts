...
// (JC.hiddenContentPage / JC.initializeHiddenContentPage).
...
function initialize(): void {
    ...
    if (!(JC as { hiddenContent?: unknown }).hiddenContent) {
    ...
    window.addEventListener('jc-hidden-content-changed', () => {
        ...
        const container = document.getElementById('jc-hidden-content-container');
...
JC.initializeHiddenContentPage = initialize;
