                        ...
                        <div style="padding: 0 16px 16px 16px;">
                            ...
                            <div style="padding: 12px; background: ${presetBoxBackground}; border-radius: 6px; border-left: 3px solid ${toggleAccentColor};">
                                ...
                                <div id="subtitlePositionGrid" style="position:relative; width:min(60vw,280px); height:min(34vw,158px); background:rgba(0,0,0,0.4); border:1px solid rgba(255,255,255,0.15); border-radius:6px; cursor:crosshair; user-select:none; overflow:hidden; margin: 0 auto;">
                                    ...
                                    <div id="subtitlePositionPreview" style="position:absolute; transform:translate(-50%,-100%); pointer-events:none; white-space:nowrap; font-size:${subtitlePreview.previewFontSizePx}px; font-family:${escapeHtml(subtitlePreview.fontFamily)}; font-weight:600; color:${subtitlePreview.textColor}; background-color:${subtitlePreview.backgroundColor}; padding:${subtitlePreview.visibleBackground ? '0.08em 0.2em' : '0'}; border-radius:${subtitlePreview.visibleBackground ? '0.15em' : '0'}; text-shadow:${subtitlePreview.textShadow}; left:${clampSubtitleHorizontal(settings.subtitleHorizontalPosition)}%; top:${clampSubtitleVertical(settings.subtitleVerticalPosition)}%;">AaBbCcDd</div>
                                </div>
