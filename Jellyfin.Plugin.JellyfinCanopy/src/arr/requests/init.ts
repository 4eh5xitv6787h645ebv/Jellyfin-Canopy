...
// polling and the public JC.downloadsPage surface (split from requests-page.js).
// The poll interval and the navigation-watcher fallback interval are tracked
// with a core lifecycle handle.
// Public surface (frozen): JC.downloadsPage + JC.initializeDownloadsPage —
...
/** The frozen JC.downloadsPage contract (js/plugin.js + PluginPages HTML). */
...
function showPage(): void {
    ...
    const activePage = document.querySelector(
        '.mainAnimatedPage:not(.hide):not(#jc-downloads-page)',
    );
    if (activePage) {
...
function hidePage(): void {
    ...
    const page = document.getElementById('jc-downloads-page');
    if (page) {
...
function injectNavigation(): void {
    ...
    if (document.querySelector('.jc-nav-downloads-item')) {
        return;
    }
    ...
    if (jellyfinCanopySection) {
        ...
        navItem.className =
            'navMenuOption lnkMediaFolder emby-button jc-nav-downloads-item';
        navItem.href = '#';
...
function initialize(): void {
    ...
    document.addEventListener('viewshow', (e) => {
        ...
        if (
            state.pageVisible &&
            targetPage &&
            targetPage.id !== 'jc-downloads-page'
        ) {
            hidePage();
        }
    });
    ...
    document.addEventListener(
        ...
        (e) => {
            ...
            if (btn && !btn.classList.contains('jc-nav-downloads-item')) {
...
JC.initializeDownloadsPage = initialize;
