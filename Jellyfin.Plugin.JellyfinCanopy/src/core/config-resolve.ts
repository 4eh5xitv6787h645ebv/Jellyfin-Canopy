...
//
// JC.pluginConfig is PascalCase (the raw GetPublicConfig/GetPrivateConfig
 ...
 * loader's JC.toCamelCase for top-level scalars).
 ...
 * resolution. Deliberately shallow (not the deep JC.toCamelCase): only top-level
