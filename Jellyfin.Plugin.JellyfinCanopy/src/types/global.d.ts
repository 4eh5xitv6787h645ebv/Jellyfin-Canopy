...
// the plugin's own window.JellyfinCanopy namespace. This is the src/ (real
...
declare global {
    ...
    interface JellyfinApiClient {
         ...
         * when the SDK socket bridge is unavailable (JC.core.live fails soft).
         */
        subscribe?(
            types: string[],
