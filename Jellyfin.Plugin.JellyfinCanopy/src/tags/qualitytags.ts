...
const logPrefix = '🪼 Jellyfin Canopy: Quality Tags:';
 ...
 * @param userKey - Key on JC.currentSettings
...
function readBool(userKey: string, fallback: boolean): boolean {
    const userVal = JC.currentSettings?.[userKey];
