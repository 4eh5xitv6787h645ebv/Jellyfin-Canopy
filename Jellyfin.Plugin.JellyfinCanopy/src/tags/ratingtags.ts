...
const logPrefix = '🪼 Jellyfin Canopy: Rating Tags:';
 ...
 * live config + JC.spoilerGuard accessors. Fails closed while state is loading
...
const spec: TagSpec = {
    ...
    containerClass,
    taggedAttr: 'jcRatingTagged',
    styleId: 'jellyfin-canopy-rating-tags-css',
    cache: {
        key: 'JellyfinCanopy-ratingTagsCache',
    ...
    pipeline: {
        ...
        render(ctx, el, item: any, extras: any) {
            ...
            } else if (typeof JC.appendUserRatingToContainer === 'function') {
                void JC.appendUserRatingToContainer(el, item, extras);
            }
        },
