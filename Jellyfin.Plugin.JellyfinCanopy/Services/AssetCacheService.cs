...
namespace Jellyfin.Plugin.JellyfinCanopy.Services
{
    ...
    /// /JellyfinCanopy/assets/* (AssetsController); this service populates and refreshes the
    ...
    public sealed class AssetCacheService
    {
        ...
        /// same layout as <see cref="JellyfinCanopy.BrandingDirectory"/>. Empty when the plugin
