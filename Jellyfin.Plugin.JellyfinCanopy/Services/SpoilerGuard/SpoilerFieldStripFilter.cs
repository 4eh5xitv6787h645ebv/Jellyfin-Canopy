...
namespace Jellyfin.Plugin.JellyfinCanopy.Services
{
    ...
    {
        // Action-name table built from live observation on Jellyfin:
            ...
            Guid userId)
        {
            try
            {
                ...
                else
                {
                    ...
                    // (fall back to ParentId lookup if absent).
        ...
        private void StripItem(BaseItemDto item, UserSpoilerBlur userState, PluginConfiguration cfg, Guid userId)
        {
            ...
            // pages — an unexpected guest star or recurring villain on the
            // series-level cast is a major spoiler. No watched-state check (a
        ...
        // when the DTO omits UserData (lite clients pass enableUserData=false).
        // Fail-CLOSED (returns false → strip) on any lookup failure.
        ...
        // JS-eval context). No JC consumer evals Overview today; if that
