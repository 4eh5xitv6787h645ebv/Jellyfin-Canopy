...
namespace Jellyfin.Plugin.JellyfinElevate.ScheduledTasks
{
    ...
    public partial class JellyseerrWatchlistSyncTask : IScheduledTask
    {
        ...
        public string Key => "JellyfinElevateJellyseerrWatchlistSync";
        ...
        private async Task<Dictionary<string, string>> GetJellyseerrUserMap(HttpClient httpClient, string jellyseerrUrl, string apiKey)
        {
            ...
            try
            {
                while (true)
                {
                    ...
                    using var request = Jellyfin.Plugin.JellyfinElevate.Helpers.Jellyseerr.SeerrHttpHelper.BuildRequest(
                        HttpMethod.Get, requestUri, apiKey);
                    using var response = await httpClient.SendAsync(request);
                    var (content, error) = await Jellyfin.Plugin.JellyfinElevate.Helpers.Jellyseerr.SeerrHttpHelper.ReadResponseAsync(response, requestUri);
