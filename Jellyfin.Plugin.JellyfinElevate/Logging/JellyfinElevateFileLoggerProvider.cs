...
namespace Jellyfin.Plugin.JellyfinElevate.Logging
{
    ...
    /// <c>JellyfinElevate_yyyy-MM-dd.log</c> file. The file is a documented
    ...
    /// </summary>
    public sealed class JellyfinElevateFileLoggerProvider : ILoggerProvider
    {
        private readonly IApplicationPaths _appPaths;
        private readonly object _writeLock = new object();
        private const int LogRetentionDays = 3; // How many days of logs to keep
        private const string LogFilePrefix = "JellyfinElevate_";
        ...
        public JellyfinElevateFileLoggerProvider(IApplicationPaths appPaths)
        {
            _appPaths = appPaths;
        ...
        internal void Write(LogLevel logLevel, string sanitizedMessage)
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"Failed to write to JellyfinElevate log file: {ex.Message}");
            }
        }
        ...
        private sealed class FileLogger : ILogger
        {
            ...
            public FileLogger(JellyfinElevateFileLoggerProvider provider) => _provider = provider;
