...
namespace Jellyfin.Plugin.JellyfinElevate.Services
{
    ...
    /// /JellyfinElevate/assets/* (AssetsController); this service populates and refreshes the
    ...
    public sealed class AssetCacheService
    {
        ...
        /// same layout as <see cref="JellyfinElevate.BrandingDirectory"/>. Empty when the plugin
        /// instance is not available yet.
        /// </summary>
        internal string CacheDirectory => _cacheDirectoryOverride ?? JellyfinElevate.AssetCacheDirectory;
