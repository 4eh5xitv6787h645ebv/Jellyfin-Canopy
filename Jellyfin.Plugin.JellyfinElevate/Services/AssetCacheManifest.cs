...
namespace Jellyfin.Plugin.JellyfinElevate.Services
{
    ...
    /// </summary>
    /// <param name="Key">Relative cache key served at /JellyfinElevate/assets/{Key}.</param>
    ...
    /// /JellyfinElevate/assets/*. This manifest is the only source of upstream URLs — the cache
    ...
    internal static class AssetCacheManifest
    {
        ...
        internal static readonly IReadOnlyList<EmbeddedAssetDescriptor> EmbeddedAssets = new[]
        {
            ...
            new EmbeddedAssetDescriptor(
                ...
                "Jellyfin.Plugin.JellyfinElevate.Assets.poster-fallback.svg",
                "image/svg+xml"),
            ...
            new EmbeddedAssetDescriptor(
                "ratings/ratings.css",
                "Jellyfin.Plugin.JellyfinElevate.Assets.ratings.css",
                "text/css"),
        };
        ...
        private static IReadOnlyList<AssetDescriptor> BuildStaticAssets()
        {
            ...
            var assets = new List<AssetDescriptor>
            {
                ...
                // ../JellyfinElevate/assets/... URLs with an onerror CDN fallback), so they are
