...
using Jellyfin.Plugin.JellyfinElevate.EventHandlers;
...
namespace Jellyfin.Plugin.JellyfinElevate
{
    public class PluginServiceRegistrator : IPluginServiceRegistrator
    {
        public void RegisterServices(IServiceCollection serviceCollection, IServerApplicationHost applicationHost)
        {
            ...
            serviceCollection.AddSingleton<Logging.JellyfinElevateFileLoggerProvider>();
            ...
            // /JellyfinElevate/assets/* and refreshed daily by RefreshCachedAssetsTask —
