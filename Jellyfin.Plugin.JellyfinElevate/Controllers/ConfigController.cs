...
namespace Jellyfin.Plugin.JellyfinElevate.Controllers
{
    ...
    [ApiController]
    public class ConfigController : JellyfinElevateControllerBase
    {
        ...
        // Client bundle + bootstrap loaders (dist/je.bundle.js, splashscreen,
        ...
        public ActionResult GetVersion()
        {
            ...
            return Content(JellyfinElevate.Instance?.Version.ToString() ?? "unknown");
        }
        ...
        /// JellyfinElevate.Tests/Snapshots.
        /// </summary>
        ...
        {
            var prefix = "Jellyfin.Plugin.JellyfinElevate.js.locales.";
            var suffix = ".json";
        ...
        public ActionResult GetLocale(string lang)
        {
            ...
            var resourcePath = $"Jellyfin.Plugin.JellyfinElevate.js.locales.{sanitizedLang}.json";
            ...
            if (stream == null && sanitizedLang.Contains('-'))
            {
                ...
                var fallbackPath = $"Jellyfin.Plugin.JellyfinElevate.js.locales.{baseLang}.json";
        ...
        {
            var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"Jellyfin.Plugin.JellyfinElevate.{resourcePath.Replace('/', '.')}");
