...
// window.JellyfinElevate — the members that external consumers depend on and
...
/**
 * The frozen public API of window.JellyfinElevate. Signatures here MUST match
 * the corresponding JEGlobal members exactly (JEGlobal extends this interface).
 */
export interface JellyfinElevatePublicApi {
