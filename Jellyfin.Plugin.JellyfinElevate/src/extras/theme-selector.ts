...
const getLocalStorageValue = (userId: string, key: string, defaultValue: string | null = null): string | null => {
    try {
        ...
        console.error('🪼 Jellyfin Elevate: Theme selector storage read error', e);
        return defaultValue;
    }
};
...
const setLocalStorageValue = (userId: string, key: string, value: string): boolean => {
    try {
        ...
        console.error('🪼 Jellyfin Elevate: Theme selector storage write error', e);
        return false;
    }
};
...
JE.initializeThemeSelector = initialize;
