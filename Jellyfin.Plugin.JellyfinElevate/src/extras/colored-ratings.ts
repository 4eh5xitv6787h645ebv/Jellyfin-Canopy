...
function isFeatureEnabled(): boolean {
    return Boolean(window?.JellyfinElevate?.pluginConfig?.ColoredRatingsEnabled);
}
...
function injectCSS(): void {
    ...
    try {
        ...
        console.error('🪼 Jellyfin Elevate: Failed to inject ratings CSS', error);
    }
}
...
function processRatingElements(): void {
    try {
        ...
        console.error('🪼 Jellyfin Elevate: Error processing rating elements', error);
    }
}
...
function setupMutationObserver(): boolean {
    ...
    try {
        ...
        console.error('🪼 Jellyfin Elevate: Failed to setup ratings observer', error);
        return false;
    }
}
