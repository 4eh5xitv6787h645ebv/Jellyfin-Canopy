...
//
// js/plugin.js (the loader, served at /JellyfinElevate/script) creates the
// window.JellyfinElevate namespace, fetches config/user settings, then loads
...
// Frozen public-contract anchor: JEGlobal extends JellyfinElevatePublicApi
// (src/facade.ts) — the single typed home for the stable window.JellyfinElevate
...
type _FrozenPublicApi = JEGlobal extends JellyfinElevatePublicApi ? true : never;
