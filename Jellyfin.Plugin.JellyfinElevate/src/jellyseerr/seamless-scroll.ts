// src/jellyseerr/seamless-scroll.ts
...
/** Seamless infinite-scroll utility (JE.seamlessScroll). */
...
declare module '../types/je' {
    interface JEGlobal {
        /** Seamless infinite-scroll utility (src/jellyseerr/seamless-scroll.ts). */
...
const logPrefix = '🪼 Jellyfin Elevate: Seamless Scroll:';
