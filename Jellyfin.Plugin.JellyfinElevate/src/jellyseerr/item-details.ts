...
const logPrefix = '🪼 Jellyfin Elevate: Jellyseerr Recommendations:';
const requestMoreLogPrefix = '🪼 Jellyfin Elevate: Series Request More:';
...
async function renderSeriesRequestMoreButton(itemId: string) {
    ...
    try {
        ...
        if (!hasUnrequested) {
            ...
            // HTTP request to /JellyfinElevate/jellyseerr/request, so we
