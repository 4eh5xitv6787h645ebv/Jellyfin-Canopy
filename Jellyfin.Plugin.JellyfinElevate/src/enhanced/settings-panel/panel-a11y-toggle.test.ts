...
describe('settings panel toggle-close releases the modal-a11y handle', () => {
    beforeEach(async () => {
        ...
        (window.JellyfinElevate as any).toCamelCase = (x: unknown) => x;
    ...
    it('open → toggle-close drops the je-modal-open gate and removes the capture keydown listener', async () => {
        ...
        expect(document.getElementById('jellyfin-elevate-panel')).not.toBeNull();
        ...
        expect(document.getElementById('jellyfin-elevate-panel')).toBeNull();
