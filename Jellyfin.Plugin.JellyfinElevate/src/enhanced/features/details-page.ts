        ...
        button.onclick = (e) => {
            ...
            void (async () => {
                ...
                try {
                    ...
                    console.warn('🪼 Jellyfin Elevate: Could not fetch item metadata for hide button', err);
                }
                    ...
                    (JE as any).hiddenContent.confirmAndHide(baseItemData, () => {
                        ...
                        onChooseShow: async () => {
                            ...
                            try {
                                ...
                                console.warn('🪼 Jellyfin Elevate: Could not fetch series metadata for hide-show action', err);
                            }
...
const handleItemDetails = debounce(() => {
    ...
    console.warn('🪼 Jellyfin Elevate: Error in item details handler', e);
}
}, 100);
