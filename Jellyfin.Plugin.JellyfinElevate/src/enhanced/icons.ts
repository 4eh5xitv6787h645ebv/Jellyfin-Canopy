...
//
// Icon name constants + emoji/Lucide/MUI icon sets, exposed as JE.icon /
// JE.IconName / JE.icons.
// (Converted from js/enhanced/icons.js — bodies semantically identical.)

import { JE } from '../globals';

console.log('🪼 Jellyfin Elevate: Icons: Module loading...');
...
JE.icon = function (name: string): string {
...
console.log('🪼 Jellyfin Elevate: Icons: Module loaded successfully. JE.icon is now available.');
