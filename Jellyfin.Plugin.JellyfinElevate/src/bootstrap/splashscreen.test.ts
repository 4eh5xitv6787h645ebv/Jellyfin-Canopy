...
// initializeSplashScreen / hideSplashScreen to window.JellyfinElevate. Each
...
function api(): SplashApi {
    return window.JellyfinElevate as unknown as SplashApi;
}
...
describe('splashscreen teardown on the hide path', () => {
    beforeEach(() => {
        ...
        window.JellyfinElevate.pluginConfig = { EnableCustomSplashScreen: true };
    });
