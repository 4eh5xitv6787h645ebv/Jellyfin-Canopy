...
//
// JEGlobal is the typed view of window.JellyfinElevate — the global contract
...
import type { JellyfinElevatePublicApi } from '../facade';

/**
 * Admin plugin configuration as delivered by /JellyfinElevate/public-config
...
/**
 * window.JellyfinElevate — created by js/plugin.js before the bundle loads.
 ...
 *
 * Extends {@link JellyfinElevatePublicApi} (src/facade.ts) — the frozen public
 ...
 */
export interface JEGlobal extends JellyfinElevatePublicApi {
    core: JECore;
    ...
    // JellyfinElevatePublicApi (src/facade.ts).
}
