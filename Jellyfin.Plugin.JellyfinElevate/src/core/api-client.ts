...
//   JE.core.api.plugin(path, options)— same, targeting /JellyfinElevate/ endpoints
...
const logPrefix = '🪼 Jellyfin Elevate: Request Manager:';
...
console.log('🪼 Jellyfin Elevate: API client core initialized');
