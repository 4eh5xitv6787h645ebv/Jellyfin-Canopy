        ...
        const live = await page.evaluate(() => {
            ...
            try {
                for (let index = 0; index < 12; index += 1) {
                    ...
                    streamProgress.parentElement!.setAttribute('aria-valuenow', String(value));
