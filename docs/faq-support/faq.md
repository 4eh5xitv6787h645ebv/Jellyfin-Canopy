...
|--------|-------------|----------------|-------|
| Jellyfin Elevate | ✅ | ❌ | Jellyfin 10.11 users: install the original [Jellyfin Enhanced](https://github.com/n00bcodr/Jellyfin-Enhanced) plugin instead — see [Migrating to v12](../installation/migrating-to-v12.md) |
