...
namespace Jellyfin.Plugin.JellyfinCanopy.Tests.Services
{
    ...
    public class MaintenanceModeConcurrencyTests : IDisposable
    {
        ...
        {
            _baseDir = Path.Combine(Path.GetTempPath(), "jc-maint-concurrency-" + Guid.NewGuid().ToString("N"));
            Directory.CreateDirectory(_baseDir);
            _stateFilePath = Path.Combine(_baseDir, "configurations", "Jellyfin.Plugin.JellyfinCanopy", "maintenance-state.json");
        }
