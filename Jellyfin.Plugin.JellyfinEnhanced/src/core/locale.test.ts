...
describe('formatDate', () => {
    it('formats the month name in the resolved display locale', () => {
        ...
        JE.currentSettings = { displayLanguage: 'en' };
        expect(formatDate(date, { month: 'long', day: 'numeric' })).toContain('February');
        JE.currentSettings = { displayLanguage: 'de' };
