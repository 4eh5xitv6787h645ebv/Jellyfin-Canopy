...
// initializeSplashScreen / hideSplashScreen to window.JellyfinEnhanced. Each
...
function api(): SplashApi {
    return window.JellyfinEnhanced as unknown as SplashApi;
}
...
describe('splashscreen teardown on the hide path', () => {
    beforeEach(() => {
        ...
        window.JellyfinEnhanced.pluginConfig = { EnableCustomSplashScreen: true };
    });
