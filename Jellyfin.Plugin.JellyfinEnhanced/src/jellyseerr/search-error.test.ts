...
describe('jellyseerr api.search error channel', () => {
    ...
    function api(): { search: (q: string, p?: number, o?: unknown) => Promise<{ results: unknown[]; error?: string }> } {
        return (window.JellyfinEnhanced as unknown as { jellyseerrAPI: { search: (q: string, p?: number, o?: unknown) => Promise<{ results: unknown[]; error?: string }> } }).jellyseerrAPI;
    }
