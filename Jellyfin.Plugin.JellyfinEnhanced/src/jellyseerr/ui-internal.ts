...
// `JE.jellyseerrUI = JE.jellyseerrUI || {}` pattern: every ui-* module imports
...
/** Shared internal helper bag (was JE.internals.jellyseerrUi). */
...
/** The public UI surface, published on JE.jellyseerrUI. */
export const ui: JellyseerrUI = (JE.jellyseerrUI = JE.jellyseerrUI || {});
