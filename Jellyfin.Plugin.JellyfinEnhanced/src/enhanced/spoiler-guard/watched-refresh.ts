...
// subscribes to the platform's own push channel (JE.core.live
...
function scheduleRefresh(): void {
    ...
    debounceTimer = window.setTimeout(() => {
        ...
        catch (e) { console.warn('🪼 Jellyfin Enhanced [SpoilerGuard]: auto-refresh after watched-flip failed:', e); }
    }, REFRESH_DEBOUNCE_MS);
}
