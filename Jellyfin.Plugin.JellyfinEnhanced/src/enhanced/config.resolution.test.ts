...
// JE.pluginConfig; it now resolves through the shared camelCase adminDefaultsView.
import { afterEach, beforeEach, describe, expect, it } from 'vitest';
import { JE } from '../globals';
import './config'; // registers JE.loadSettings
...
function loadWith(settings: Record<string, unknown>, pluginConfig: Record<string, unknown>): Record<string, unknown> {
    ...
    JE.pluginConfig = pluginConfig;
    return JE.loadSettings!();
}
