...
namespace Jellyfin.Plugin.JellyfinEnhanced.Services
{
    ...
    /// </summary>
    /// <param name="Key">Relative cache key served at /JellyfinEnhanced/assets/{Key}.</param>
    ...
    /// /JellyfinEnhanced/assets/*. This manifest is the only source of upstream URLs — the cache
    ...
    internal static class AssetCacheManifest
    {
        ...
        internal static readonly IReadOnlyList<EmbeddedAssetDescriptor> EmbeddedAssets = new[]
        {
            ...
            new EmbeddedAssetDescriptor(
                ...
                "Jellyfin.Plugin.JellyfinEnhanced.Assets.poster-fallback.svg",
                "image/svg+xml"),
        };
        ...
        private static IReadOnlyList<AssetDescriptor> BuildStaticAssets()
        {
            ...
            var assets = new List<AssetDescriptor>
            {
                ...
                // -- Colored ratings CSS (upstream repo @main, so it can evolve between releases) --
                new AssetDescriptor(
                    "ratings/ratings.css",
                    "https://cdn.jsdelivr.net/gh/n00bcodr/Jellyfin-Enhanced@main/css/ratings.css",
                    "text/css",
                    TextCap,
                    Rewrite: true,
                    AllowedDerivedPrefixes: new[] { "https://cdn.jsdelivr.net/gh/n00bcodr/Jellyfin-Enhanced" }),
